...
uv run vLLM_filtering_mod.py \
    --dataset-prefix a \
    --predicates "at location" "capable of" "causes" "created by" "defined as" "desires" "distinct from" "has a" "has first subevent" "has prerequisite" "has property" "has subevent" "manner of" "motivated by goal" "part of" "receives action" "used for"
