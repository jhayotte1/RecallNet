...
uv run vLLM_classify_mod.py \
    --dataset-prefix q \
    --predicates "at location" "capable of" "causes" "created by" "defined as" "desires" "distinct from" "has a" "has first subevent" "has prerequisite" "has property" "has subevent" "made of" "manner of" "motivated by goal" "part of" "receives action" "used for"
