...
from config import MODEL_NAME, MODEL_PROVIDER, STRUCTURED_OUTPUT_METHOD, BATCH_SIZE, TEMPERATURE, SYSTEM_PROMPT_PATH, MAX_CONCURRENCY
...
def classify_batches(batches, config=None):
