...
if __name__ == "__main__":
    ...
    data_dir = INPUT_DIR / f"{dp}_final_process" / "06_RESCORING" / "03_Splitting" / "INBETWEEN"
    output_dir = INPUT_DIR / f"{dp}_final_process" / "06_RESCORING" / "04_Filtering"
    ...
    for pred in args.predicates:
        ...
        chunk_files = sorted(pred_dir.glob(f"ib_{pred_parsed}_*.csv"))
        if not chunk_files:
